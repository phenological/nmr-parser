test_that("reading inexistent file", {
  title <- readTitle(system.file("..", "tests", "testthat", "title", package = "nmr.parser"))
  expect_equal(title, NULL)
})

test_that("reading title single line", {
  title <- readTitle(system.file("..", "tests", "testthat", "title_singleline", package = "nmr.parser"))
...
test_that("reading title multiple lines", {
  title <- readTitle(system.file("..", "tests", "testthat", "title_multiline", package = "nmr.parser"))
  expect_equal(title$path, "title")
  expect_equal(title$name, "title")
